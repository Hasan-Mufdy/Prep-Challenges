...
const oddFiltration = (arr) => {
    ...
    let oddArray = arr.filter(n => n % 2 !== 0);
    return oddArray;
}
// -------------------------------------------------------------------------------------------------------
...
const cvsFiltration = (arr) => {
    // write your code here
    let cvArray = arr.filter(cv => cv.yearsOfExperience >= 4 && cv.tech === "JS");
    let fullName;
...
const vowelsFiltration = (arr) => {
    // write your code here
    let vowArray = arr.filter(w => !(w.includes('a') || w.includes('e') || w.includes('i') || w.includes('o') || w.includes('u')));
    return vowArray;
} 
// -------------------------------------------------------------------------------------------------------
